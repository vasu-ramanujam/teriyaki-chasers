...
from app.routers import species, sightings, routing, identify, user, animalsearch
...
app.include_router(animalsearch.router, prefix="/v1/animal-search", tags=["animal-search"])
